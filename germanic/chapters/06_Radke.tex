  ...
  \begin{figure}
   \begin{tikzpicture}%[trim axis right,trim axis left]
    \begin{axis}[
        ...
        symbolic y coords={{ou/oukie},net,mooi,lekker,bikkie,kak,{plek/plekke},{jerre/jirre},mos,gees},
        ]
...
\begin{tikzpicture}%[trim axis right,trim axis left]
    \begin{axis}[
        ...
        \addplot[black!30,fill=black!30] plot coordinates {
               (total, 68)
               (Windhoek, 69)
               (Swakopmund, 66)
               (rural, 56)
